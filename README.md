...
**Link to Project:** [SpaceX Rocket Landing Classification](https://github.com/Jsanchez759/Data-Related-Projects/tree/main/backup_projects/Machine_Learning/classification/spaceX_classification_project)
...
**Link to Project:** [Mama Cancer Analysis and prediction](https://github.com/Jsanchez759/Data-Related-Projects/blob/main/backup_projects/Machine_Learning/classification/mama_cancer_analysis.ipynb)
...
**Link to Project:** [Sunflower Classification with Convolutional Neural Networks](https://github.com/Jsanchez759/Data-Related-Projects/tree/main/backup_projects/Machine_Learning/neural_Networks/Image_Analysis/flower_classification)
...
**Link to Project:** [Concept Analysis of Neural Networks](https://github.com/Jsanchez759/Data-Related-Projects/blob/main/backup_projects/Machine_Learning/neural_Networks/Image_Analysis/Redes_Neuronales_Analisis.ipynb)
...
**Link to Project:** [Image Detection Using pretrained YOLOv5](https://github.com/Jsanchez759/Data-Related-Projects/blob/main/backup_projects/Machine_Learning/neural_Networks/Image_Analysis/YOLO_Transfer_Learning.ipynb)
...
**Link to Project:** [Car Price Prediction](https://github.com/Jsanchez759/Data-Related-Projects/blob/main/backup_projects/Machine_Learning/regression/car_price_prediction/Car_Price_Analysis_prediction.ipynb)
...
**Link to Project:** [Real State Price Prediction](https://github.com/Jsanchez759/Data-Related-Projects/tree/main/backup_projects/Machine_Learning/regression/real_state_app)
...
**Link to Project:** [Comparison of 3 Deep Learning techniques for Colombian Energy Price Forescasting](https://github.com/Jsanchez759/Data-Related-Projects/tree/main/backup_projects/master_degree_project/project)
...
**Link to Project:** [Data analysis projects](https://github.com/Jsanchez759/Data-Related-Projects/tree/main/backup_projects/Data_Analysis)
...
**Link to Project:** [NLP for Sentiment Analysis](https://github.com/Jsanchez759/Data-Related-Projects/blob/main/backup_projects/Machine_Learning/neural_Networks/Language_Analysis/Sentiment_Analysis.ipynb)
...
**Link to Project:** 
- [App](https://github.com/Jsanchez759/Data-Related-Projects/tree/main/backup_projects/Machine_Learning/generative_AI/chat_with_PDF)
...
**Link to Project:** 
- [Fine Tunning Project](https://github.com/Jsanchez759/Data-Related-Projects/tree/main/backup_projects/Machine_Learning/generative_AI/GPT_Turbo_Fine_Tunning)
...
**Link to Project:** 
- [LLM Chatbot](https://github.com/Jsanchez759/Data-Related-Projects/tree/main/backup_projects/Machine_Learning/generative_AI/text_generation_runpod)
...
**Link to Project:** 
- [Project](https://github.com/Jsanchez759/Data-Related-Projects/tree/main/backup_projects/Machine_Learning/ml_complete_project)
...
**Link to Project:** 
- [Project](https://github.com/Jsanchez759/Data-Related-Projects/tree/main/backup_projects/Optimization_Project)
...
**Link to Project:** 
- [Project](https://github.com/Jsanchez759/Data-Related-Projects/blob/main/backup_projects/Machine_Learning/neural_Networks/Language_Analysis/emotion_detection_app)

## Project 17: Development and compare RAG in Generative Models

**Description:**

This project implements a chatbot system that uses the Retrieval-Augmented Generation (RAG) technique to improve the responses generated by a language model. The system is based on the use of the HuggingFace transformers library for language modeling, and Pinecone for indexing and searching relevant documents. The key points of this program are:

o Hugging Face's T5Tokenizer and T5ForConditionalGeneration are used for model response generation, and AutoTokenizer and AutoModel are used for RAG embeddings generation.
o The google/flan-t5-large model that can be found at this link is used to obtain answers.
o For RAG data, the rag-datasets/rag-mini-bioasq dataset from HuggingFace is used which can be found at this link and get information

**Technologies Used:** Python, Hugging Face, Transformer PreTrained Models, Pinecone

**Link to Project:** 
- [Project](https://github.com/Jsanchez759/Data-Related-Projects/tree/main/backup_projects/Machine_Learning/generative_AI/rag_development)
...
This project configures an environment for the preparation, training, generation and evaluation of a language model based on GPT-2 using PyTorch. For this case, it was chosen to use the retrained text generation model and its own embedding model, also the Pytorch DataLoader and Dataset classes were used to be more efficient the preparation of the training text. 

Then, it can be seen in the file train_model.py how the model is trained with new data or text using the AdamW optimizer with a predefined learning rate, using the predefined Pytorch steps for the retraining of the model network weights, 

Continuing with the process flow, in the file generate_text.py as you can generate responses from that model, this process being done from using the same embedding for and vectorization for the prompt, and then doing the reverse process for the model response.

And finally, within the evaluate_model.py file the perplexity of the model and its responses are measured.
...
**Link to Project:** 
- [Project](https://github.com/Jsanchez759/Data-Related-Projects/tree/main/backup_projects/Machine_Learning/generative_AI/text_cluster_analysis)
